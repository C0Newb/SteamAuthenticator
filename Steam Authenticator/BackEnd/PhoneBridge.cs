...
namespace SteamAuthenticator.BackEnd
{
    public class PhoneBridge
    {
        ...
        public delegate void BridgeOutput(string message);
        public event BridgeOutput PhoneBridgeError;
        public event BridgeOutput OutputLog;
        private void OnPhoneBridgeError(string message)
        {
            PhoneBridgeError?.Invoke(message);
        }
        private void OnOutputLog(string msg)
        {
            OutputLog?.Invoke(msg);
            if (OutputToLog)
                AppendToLog(msg);
        }
        ...
        private void InitConsole()
        {
            ...
            {
                if (e?.Data == null || e.Data.Contains(">@") || !OutputToConsole || String.IsNullOrEmpty(e.Data)) return;
                if (OutputToConsole)
        ...
        public SteamGuardAccount ExtractSteamGuardAccount(string id = "*", bool skipChecks = false)
        {
            ...
            InitConsole(); // Initiate the console
        ...
        private string GetDeviceID(bool root)
        {
            ...
            void f1(object sender, DataReceivedEventArgs e)
            {
                if (e.Data.Contains(">@") || String.IsNullOrEmpty(e.Data)) return;
        ...
        {
            MoreThanOneAccount?.Invoke(accounts);
        }
        ...
        {
            DeviceWaited?.Invoke(this, EventArgs.Empty);
        }
